...
#algorithm("Find-Augmenting-Path", params: ([$G$], [$M$]))[
  ...
  #aline(indent: 5)[$P_("contracted") <-$ path from root $s$ to $u$ in $T$, plus edge $(u, v)$]
  #aline(indent: 5)[$P_("original") <-$ lift $P_("contracted")$]
  #aline(indent: 5)[#Return $P_("original")$]
  ...
  #aline(indent: 5)[#Continue searching on the contracted tree]
